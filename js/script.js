...
window.onload = function() {
    var containerMale = document.getElementById("player-container-male");
    var containerFemale = document.getElementById("player-container-female");
    ...
    jogadores.forEach(function(jogador) {
        ...
        card.addEventListener('click', function() {
            localStorage.setItem('selectedPlayer', JSON.stringify(jogador));
            window.location.href = 'detalhes.html';
        });

        if (jogador.elenco === "masculino") {
            containerMale.appendChild(card);
        } else if (jogador.elenco === "feminino") {
            containerFemale.appendChild(card);
        }
    });
}